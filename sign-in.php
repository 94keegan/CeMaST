                ...
                <div class="col-md-12 box_wrapper">
                    <div class="col-md-12">
                        <div class="box">
							...
							?>
                                <form action="includes/process_login.php" method="post" name="login_form" id="my_form">
					...
					<!--<p class="already"><a href="reset.php">Forgot password?</a></p>-->
                    <p class="already">Don't have an account? <a href="sign-up.php"> Sign up</a></p>
                </div>
            </div>
        </div>
    </div>
