...
define("USER", "p6q5n6g8_cemast");    // The database username. 
define("PASSWORD", "dontMessthisup43");    // The database password. 
define("DATABASE", "p6q5n6g8_cemastDB");    // The database name.
